...
This image does not come with an automated way to periodicly restart.  
...
Needs different time or interfall but lacking knowledge of cron? Check https://crontab.guru/
